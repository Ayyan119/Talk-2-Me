...
async def main_async() -> None:
    ...
    print("=" * 65)
    print("  Talk-To-Me: Voice-Operated LLM Assistant with Memory")
    print("=" * 65)
    print("Initializing system configuration and models...")
    ...
    try:
        ...
        print("Please check your .env file and configure the required API keys.\n")
        sys.exit(1)
    ...
    print("-" * 65)
    print("🎙️ Voice assistant is ready. Start speaking into your microphone!")
    print("💡 Press Ctrl+C to stop the assistant and exit.")
    print("-" * 65)
    ...
    try:
        ...
        print("Goodbye! Voice assistant has stopped cleanly.")
